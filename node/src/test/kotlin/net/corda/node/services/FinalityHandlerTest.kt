...
import net.corda.node.services.statemachine.StaffedFlowHospital.MedicalHistory.Record.KeptInForObservation
...
class FinalityHandlerTest {
    ...
    fun `sent to flow hospital on error and attempted retry on node restart`() {
        ...
        val observations = bob.smm.flowHospital.patients[finalityHandlerId]!!.records.filterIsInstance<KeptInForObservation>()
